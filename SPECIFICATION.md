...
- **🔍 Сканирование сайтов** — обход до 5 уровней глубины, рендеринг JavaScript
- **📊 Оптимизированная таблица** — группировка нарушений (слово xN), экономия 90% трафика
- **📝 Анализ текста** — морфологический разбор через pymorphy3
- **📚 Словари** — интеграция с официальными словарями
- **🛡 Исключения** — бренды и глобальные исключения
...
- ✅ Лимит на выдачу нарушений (`?limit=1000`)
- ✅ Оптимизированная таблица (90% экономия)
- ✅ Цветовая индикация частоты

**Исправления:**
- ✅ Удаление сканов (исправлена проверка `resp.data`)
- ✅ Исключения (e-mail, JavaScript методы)
- ✅ Извлечение текста (только видимый)
